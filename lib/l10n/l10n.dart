...
class L10n {
  ...
  static const Map<String, Map<String, String>> _strings = {
    "en": {
      ...
      "offers_list_title": "Offers from contractors",
      "offers_submitted_title": "My offers",
      "offers_empty":
          "No contractor offers yet. Publish a project to start receiving them.",
      "offers_submitted_empty": "You have not submitted any offers yet.",
      "offers_load_failed": "Could not load offers.",
      "offers_sign_in_required": "Sign in to view contractor offers.",
      "offers_project_fallback": "Renovation project",
      "offers_published_on": "Published {date}",
      "offers_duration_days": "{count} days",
      ...
      "project_room_duplicate_confirm_title": "Duplicate this scan?",
      "project_room_duplicate_confirm_message":
          "An independent copy of \"{name}\" will be created. You can edit or delete either scan separately.",
      "project_room_duplicate_confirm": "Create duplicate",
      "project_room_duplicate_progress": "Creating an independent copy…",
      "project_room_duplicate_success": "Scan duplicate created",
      "project_room_duplicate_failed": "Could not duplicate the scan",
      "project_room_duplicate_name": "{name} — copy",
      ...
      "room_3d_floor_plan_install_window": "Install window here",
      "room_3d_floor_plan_install_window_title": "Add window here?",
    ...
    "ru": {
      ...
      "offers_list_title": "Предложения подрядчиков",
      "offers_submitted_title": "Мои предложения",
      "offers_empty":
          "Предложений пока нет. Опубликуйте проект, чтобы получать отклики подрядчиков.",
      "offers_submitted_empty": "Вы пока не отправили ни одного предложения.",
      "offers_load_failed": "Не удалось загрузить предложения.",
      "offers_sign_in_required": "Войдите, чтобы посмотреть предложения.",
      "offers_project_fallback": "Проект ремонта",
      "offers_published_on": "Опубликовано {date}",
      "offers_duration_days": "{count} дней",
      ...
      "project_room_duplicate_confirm_title": "Создать дубликат скана?",
      "project_room_duplicate_confirm_message":
          "Будет создана независимая копия «{name}». Каждый скан можно изменять или удалять отдельно.",
      "project_room_duplicate_confirm": "Создать дубликат",
      "project_room_duplicate_progress": "Создаём независимую копию…",
      "project_room_duplicate_success": "Дубликат скана создан",
      "project_room_duplicate_failed": "Не удалось создать дубликат скана",
      "project_room_duplicate_name": "{name} — копия",
      ...
      "room_3d_floor_plan_install_window": "Установить окно здесь",
      "room_3d_floor_plan_install_window_title": "Добавить окно здесь?",
      "room_3d_floor_plan_install_window_message":
    ...
    "uz": {
      ...
      "offers_list_title": "Ustalardan takliflar",
      "offers_submitted_title": "Mening takliflarim",
      "offers_empty":
          "Hozircha takliflar yo'q. Ustalardan taklif olish uchun loyihani e'lon qiling.",
      "offers_submitted_empty": "Siz hali hech qanday taklif yubormagansiz.",
      "offers_load_failed": "Takliflarni yuklab bo'lmadi.",
      "offers_sign_in_required": "Takliflarni ko'rish uchun tizimga kiring.",
      "offers_project_fallback": "Ta'mirlash loyihasi",
      "offers_published_on": "E’lon qilingan: {date}",
      "offers_duration_days": "{count} kun",
      ...
      "project_room_duplicate_confirm_title": "Skan nusxasi yaratilsinmi?",
      "project_room_duplicate_confirm_message":
          "\"{name}\" skanining mustaqil nusxasi yaratiladi. Har bir skanni alohida o'zgartirish yoki o'chirish mumkin.",
      "project_room_duplicate_confirm": "Nusxa yaratish",
      "project_room_duplicate_progress": "Mustaqil nusxa yaratilmoqda…",
      "project_room_duplicate_success": "Skan nusxasi yaratildi",
      "project_room_duplicate_failed": "Skan nusxasini yaratib bo'lmadi",
      "project_room_duplicate_name": "{name} — nusxa",
      ...
      "room_3d_floor_plan_install_window": "Derazani shu yerga o'rnatish",
      "room_3d_floor_plan_install_window_title":
          "Deraza shu yerga qo'shilsinmi?",
      "room_3d_floor_plan_install_window_message":
