...
# picking up any new files under ios/Shared and ios/Makon3DAppClip.
#
# Usage:
...
TARGET_NAME = 'Makon3DAppClip'
BUNDLE_ID = 'com.makon3d.app.Clip'
DEPLOYMENT_TARGET = '17.0'
DEVELOPMENT_TEAM = 'D5THR62Q33'
APP_CLIP_PRODUCT_TYPE = 'com.apple.product-type.application.on-demand-install-capable'
TEST_INVOCATION_URL = 'https://scan.makon3d.uydosh.com/s/demo1234'

SOURCE_DIRS = %w[Shared Makon3DAppClip].freeze
...
target.build_configurations.each do |config|
  ...
  settings['INFOPLIST_FILE'] = 'Makon3DAppClip/Info.plist'
  settings['GENERATE_INFOPLIST_FILE'] = 'NO'
  settings['CODE_SIGN_ENTITLEMENTS'] = 'Makon3DAppClip/Makon3DAppClip.entitlements'
